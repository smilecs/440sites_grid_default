jQuery(document).ready(function ($) {
    ...
    function kutethemes_innit_carousel(){
      ...
      $('.details-item .main-img').on( "click", function(e) {
        $(this).closest('.product-details-nav').find('.details-item .main-img').removeClass('active');
        $(this).addClass('active');
        var link_img = $(this).find('img').attr('src');
        $('.product-details-view').find('.box-product-view').find('img').attr('src',link_img);
        return false;
      });
      // config
